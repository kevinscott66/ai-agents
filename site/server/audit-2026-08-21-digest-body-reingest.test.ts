 ...
 *   1. `agent/tools/approve-poll.ts:264-270` публикует статью с `body` —
 *      полным markdown-текстом.
 *   2. `agent/lib/site-ingest.ts:308-313` шлёт на тот же эндпоинт payload БЕЗ
 *      поля `body` вообще — другого формата он не умеет.
