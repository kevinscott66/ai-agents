...
- лимиты гейта: `PAID_ACTION_MAX_RUB` (1000 ₽) на заказ и `PAID_ACTION_DAILY_MAX`
...
- лимиты гейта общие с такси; частота: 10 заказов в час, расчёт 4 и статус 6 в минуту;
