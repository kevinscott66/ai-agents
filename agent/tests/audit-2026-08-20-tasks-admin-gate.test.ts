 ...
 *
 * Сервер закрывает админом создание задачи (`POST /api/tasks`,
 * lib/miniapp-server.ts:1008) и смену статуса (`POST /api/tasks/:id/status`,
 * :1068). Клиент об этом не знал ничего: «+ Новая задача», быстрые действия
 ...
 * пользователю (:1415), оттуда его и берём — ровно как Dashboard.tsx:154-162.
 *
