/**
 * Аудит 2026-08-13: `MAX_BUCKETS` был порогом уборки, а не потолком карты.
 *
...
/**
 * Зеркала приватных констант http-utils. Копия осознанная, как и у
 * `tests/miniapp-anon-rate-limit.test.ts:38` — тест не должен уметь менять
