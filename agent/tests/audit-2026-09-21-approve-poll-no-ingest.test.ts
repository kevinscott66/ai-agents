...
/**
 * Исходник без комментариев: сам разбор выше называет и переменную окружения,
 * и функцию ингеста — на то он и объяснение, почему их больше нет. Гейт
 * «имена в кавычках существуют» тут был бы прав, поэтому ищем в КОДЕ.
 */
