 ...
 * двигаются. Так `telegram-chunking.ts:69` объяснял читателю, что «юзербот
 * (userbot.ts:375) зовёт gramjs sendMessage», хотя на 375-й — пустая строка
 * внутри докстринга, а настоящая отправка живёт в `buildHandle().sendMessage`.
 *
