 ...
 *     ровно один производитель — SPLIT_TASK (action-dispatch.ts:868). Второй
 ...
 *
 *     Оркестратору предписано вести план последовательно
 *     (`ORCHESTRATION_MANDATE` в agent-prompts.ts, пункт «ЗАТЕМ веди план
 *     ПОСЛЕДОВАТЕЛЬНО»):
