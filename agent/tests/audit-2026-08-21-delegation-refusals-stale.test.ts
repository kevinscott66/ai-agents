 ...
 *
 *   | текст                          | кто производит                     |
 *   |--------------------------------|------------------------------------|
 *   | cannot delegate to self        | action-dispatch.ts:812 и :826  ✅   |
 *   | delegation cycle               | action-dispatch.ts:851 :859 :866 ✅ |
 *   | delegation depth exceeded      | НИКТО — мёртвая строка             |
 *   | no_available_agent: <role>     | action-dispatch.ts:819         ❌   |
 *   | delegate_skipped: <причина>    | action-dispatch.ts:1038        ❌   |
 *
 ...
 * удаления — action-dispatch.ts:868). Гейт не срабатывал никогда, текст никто
 * не пишет.
 *
 ...
 * воронки: handoff.ts:291-301 при остановленной цели возвращает `skipped`, а не
