...
export function verifyInitData(
  ...
  // написаниях. Само по себе это не обход подписи, но всё, что метит
  // initData по строке hash (одноразовость мутаций), обходится сменой
  // регистра: каждое написание даёт новый ключ. Канонизируем на входе.
