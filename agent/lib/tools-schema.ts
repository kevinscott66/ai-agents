 ...
 * набор, который через `gateOrDispatch` как раз НЕ идёт (см. разбор
 * инлайновой ветки в `executeTool` ниже: ни CALLER_RESTRICTED, ни строка
 * permissions к ним не применяются, и минутный бакет «все инструменты агента» их тоже не видит).
 *
